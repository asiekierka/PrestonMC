...
public class ConditionFeatureEnabledFactory implements IConditionFactory {
    @Override
    public BooleanSupplier parse(JsonContext context, JsonObject json) {
        String ftr = JsonUtils.getString(json, "feature");
        return () -> PrestonMod.isFeatureEnabled(ftr);
    }
}
